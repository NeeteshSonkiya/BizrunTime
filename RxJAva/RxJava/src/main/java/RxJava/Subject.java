...
public class Subject  {
	...
	public static void main(String[] args) throws Exception {
		Observable<Long> observableA = Observable.interval(2000, TimeUnit.MILLISECONDS).map(value -> value);
		Observable<Long> observableB = Observable.interval(2000, TimeUnit.MILLISECONDS).map(value -> value * 100L);
